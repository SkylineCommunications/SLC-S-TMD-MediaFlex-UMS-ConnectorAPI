namespace Skyline.DataMiner.ConnectorAPI.TMDMediaFlexUMS.Tests
{
    ...
    public class JobTests
    {
        ...
        public void DeserializeJobFromXml()
        {
            ...
            Assert.AreEqual("DataminerMetadataInWflow", job.PresetName);
